...
class Platform extends Joomla
{
	...
	function getBuffer(&$data) {
		...
		//get the filename
		$jfile = \JFusion\Core\Factory::getApplication()->input->get('jfile', 'index.php');
		if (!$jfile) {
			$jfile = 'index.php';
		}
		...
		if (!is_file($index_file)) {
			\JFusion\Core\Framework::raise(LogLevel::WARNING, 'The path to the requested does not exist', $this->getJname());
		} else {
